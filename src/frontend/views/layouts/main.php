                                ...
                                "items" => [
                                    ...
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ["label" => "Статус звонка", "url" => ["manager/appeal-status"]],
                                            ["label" => "Статус собеседования", "url" => ["manager/interview-status"]],
                                        ],
                                    ],
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ["label" => "Синхронизация", "url" => ["administrator/synchronization"]],
                                        ],
                                    ],
                                    [
                                        "label" => "Multilevel",
